class NewJob.Models.Job extends Backbone.Model
  defaults:
    ...
    'location': 'Rome, GA'
    'url': 'http://floyd.org'
    'description': '<p>We are current seeking an <strong>experienced Registered Nurse</strong> in our 48 bed Medicine Unit. This is a three 12 hour Night shift position. The 5C unit is a 48 bed medicine unit with an additional 5-bed direct admit unit. Our average daily census is 32-35 patients our nursing ratios are 1-5 on days and 1-6 on nights. There are 4 CANMs two for each shift that are out of staffing. Our average length of stay for our patients is about 3-4 days.</p><p>We have a very strong sense of team work on our unit. We are very busy and often discharge and admit on average 10 patients daily. Our nurses are supported with ACTs who carry 1-10 ratio. They usually have 8 patients. Our isolation rates run at approximately 30% of the patient population.</p><p>Qualified candidates should apply.</p>'
