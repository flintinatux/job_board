    ...
    unless category.jobs.any?
      (0 .. 9 + Random.new.rand(40)).to_a.each do |i|
        ...
        category.jobs.create! title: Faker::Company.catch_phrase,
          ...
          instructions: "Please send your resume to #{Faker::Internet.email}.",
          email:        Faker::Internet.email,
          highlight:    Random.new.rand < 0.3,
          created_at:   time,
          updated_at:   time,
          expires_at:   time + Job::DURATION
      end
    end
  end
end
